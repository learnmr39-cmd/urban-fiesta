const express = require("express"); const puppeteer = require("puppeteer"); const GameMonitorModule = require("./game/gameMonitor"); const BettingStrategy = require("./game/strategies");
const GameMonitor = GameMonitorModule.default || GameMonitorModule;
const app = express();
